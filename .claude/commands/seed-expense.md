...
allowed-tools: Kead, Bash(python3:*)
1
...
Read database/db.py to understand the expenses table schema, the db connection pattern, and the
database file name.
...
Indian descriptions and amounts (7):
- Food: 50-800
- Transport: 20-500
- Bills: 200-3000
- Health: 100-2000
