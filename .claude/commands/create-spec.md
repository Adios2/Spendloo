...
argument-hint: "Step number and feature name e.g. 2 registration" allowed-tools Read, Write, Glob
You are a senior developer planning
a new
feature for the
...
If you cannot infer these from
$ARGUMENTS,
ask the user to clarify before proceeding.

## Step 2 - Research the codebase
Read
these files before writing the spec:
...
If
no
new routes: state "No new routes".
...
Print ashort summary in this exact format:
